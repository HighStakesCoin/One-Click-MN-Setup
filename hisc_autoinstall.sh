...
sleep 7
    ...
    highstakes-cli stop
    sleep 5
cd ~/.highstakes/ && rm -rf blocks chainstate sporks zerocoin
cd ~/.highstakes/ && wget https://github.com/HighStakesCoin/HighStakes/releases/download/v1.0.0.0/bootstrap.zip
cd ~/.highstakes/ && unzip bootstrap.zip	
