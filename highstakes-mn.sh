...
COIN_BOOTSTRAP='https://github.com/HighStakesCoin/HighStakes/releases/download/v1.0.0.0/bootstrap.zip'
...
function important_information() {
 ...
 echo -e "${GREEN}highstakes-cli masternode status${NC}"
 echo -e "${GREEN}highstakes-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
